...
const Filters = ({ darkMode, fromDate, setFromDate, toDate, setToDate, filterByDate, clearDateFilters, sortFollowers, sortCriteria, clearSort }) => {
    return (
        <div className={`w-full flex flex-col lg:flex-row px-5 justify-between py-2 pb-4 ${darkMode ? "text-copy bg-foreground" : "text-copyLight bg-foreground/10"} transition-colors duration-300`}>
